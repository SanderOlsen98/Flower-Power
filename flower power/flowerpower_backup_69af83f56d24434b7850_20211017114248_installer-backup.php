...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'flowerpower_backup_69af83f56d24434b7850_20211017114248_archive.zip';
	const ARCHIVE_SIZE		 = '61591623';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '69af83f-17114248';
    const SECONDARY_PACKAGE_HASH = '9e7e484-17114248';
	const VERSION			 = '1.4.3';
